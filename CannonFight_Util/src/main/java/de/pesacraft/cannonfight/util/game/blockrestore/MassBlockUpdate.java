 ...
 */
public class MassBlockUpdate implements Runnable {
	...
	public MassBlockUpdate(Plugin plugin, World world) {
		this.plugin = plugin;
		this.world = world;
	...
	public void setDeferredBufferSize(int size) {
		...
		deferredBlocks = new ArrayDeque<MassBlockUpdate.DeferredBlock>(size);
	}
